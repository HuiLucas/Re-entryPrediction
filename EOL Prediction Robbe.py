...
from tudatpy.astro.time_conversion import DateTime, add_days_to_datetime
...
satellite_norad_cat_id = "2022-09-06--2022-09-07"   # NORAD catelog ID for TLE
tle_date = C3_launchdate                            # Date for TLE
...
simulation_end_epoch   = add_days_to_datetime(simulation_start_epoch, propagation_duration)
...
line1, line2 = get_tle(satellite_norad_cat_id, tle_date)
